...
Public Class Registro
    ...
    Private Sub txtUsuario_Validating(sender As Object, e As EventArgs) Handles txtUsuario.Validating
    ...
    Private Sub txtemail_Validating(sender As Object, e As EventArgs) Handles txtemail.Validating
    ...
    Private Sub txtcontrasena_Validating(sender As Object, e As EventArgs) Handles txtcontrasena.Validating
    ...
    Private Sub txtconfirmar_Validating(sender As Object, e As EventArgs) Handles txtconfirmar.Validating
